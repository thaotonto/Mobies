...
import { LOAD_POPULAR_MOVIE, LOAD_POPULAR_TV, LOAD_NOW_PLAYING_MOVIE, LOAD_AIRING_TODAY_TV, LOAD_ON_AIR_TV, LOAD_TOP_RATED_MOVIE, LOAD_TOP_RATED_TV, LOAD_COMING_SOON_MOVIE, LOAD_GENRE_MOVIE, LOAD_GENRE_TV, LOAD_TV_BY_GENRE, LOAD_MOVIE_BY_GENRE, LOAD_PEOPLE } from '../configs/constants';
...
export default function* rootSaga() {
    yield [
        ...
        takeLatest(LOAD_PEOPLE, loadPeople)
    ];
}